...
TARGET_USER_ID = 1337695424399802438  # Replace with the user's ID
...
YOUR_BOT_TOKEN = "MTMzODIyNjQwOTAyNTMwNjY2Ng.G5-Xpw.vkNU-oI5iE6bueZluZSoy3fjY0ZjOAOhMTKfgw"  # Replace with your bot's token
...
instance_warning_limit = 0  # What is the minimum amount of instances every user should be running.
